<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YeuThich.aspx.cs" Inherits="WebBanHang.YeuThich" %>
...
<body runat="server">
    ...
    <section class="products" id="products">
        <h1 class="heading">like <span>products</span></h1>
        <div class="box-container" id="listSPThich" runat="server">
